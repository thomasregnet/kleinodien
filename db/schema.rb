...
ActiveRecord::Schema.define(version: 20150326192227) do
  ...
  create_table "compilation_media", force: :cascade do |t|
    t.integer  "compilation_release_id", null: false
  ...
  add_index "compilation_media", ["compilation_release_id", "no"], name: "index_compilation_media_on_compilation_release_id_and_no", unique: true, using: :btree
  ...
  create_table "compilation_sections", force: :cascade do |t|
    ...
    t.string   "side",                  default: "A", null: false
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  end
  ...
  add_index "cr_format_clarifications", ["cr_format_id", "no"], name: "index_cr_format_clarifications_on_cr_format_id_and_no", unique: true, using: :btree
  ...
  add_index "cr_formats", ["compilation_release_id", "format_kind_id"], name: "index_cr_formats_on_compilation_release_id_and_format_kind_id", unique: true, using: :btree

  create_table "format_kinds", force: :cascade do |t|
    t.string   "name",       null: false
    t.string   "abbr"
    t.string   "note"
    t.string   "type",       null: false
  ...
  add_index "format_kinds", ["type"], name: "index_format_kinds_on_lower_name_and_type", unique: true, using: :btree
