...
ActiveRecord::Schema.define(version: 2018_11_29_103344) do
  ...
  add_foreign_key "comments", "piece_releases"
  ...
  add_foreign_key "descriptions", "piece_releases"
  ...
  add_foreign_key "ratings", "piece_releases"
