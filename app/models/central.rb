class Central < ApplicationRecord
  ...
  has_many :links, class_name: "Link", foreign_key: "source_id", primary_key: "centralable_id"
  has_many :backlinks, class_name: "Link", foreign_key: "destination_id", primary_key: "centralable_id"
end
