Feature: Find an entity by it's codes
  ...
  Scenario Outline: Find a PieceRelease by it's codes
    Given The PieceRelease with <code_key> exists
    When I call Model#find_by_codes
    Then I get this model 
  ...
  Scenario Outline: Find a Season by it's codes
    Given The Season with <code_key> exists
    When I call Model#find_by_codes
    Then I get this model 
  ...
  Scenario Outline: Find a Serial by it's codes
    Given The Serial with <code_key> exists
    When I call Model#find_by_codes
    Then I get this model 
