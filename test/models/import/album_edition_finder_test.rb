...
class Import::AlbumEditionFinderTest < ActiveSupport::TestCase
  setup do
  ...
  test "#find returns nil if AlbumArchetype does not exist" do
    ...
    assert_nil Import::AlbumEditionFinder.call(@order, @facade)
  ...
  test "#find by cheap_codes returns if AlbumEdition does exist" do
    ...
    assert_equal album_edition, Import::AlbumEditionFinder.call(@order, @facade)
